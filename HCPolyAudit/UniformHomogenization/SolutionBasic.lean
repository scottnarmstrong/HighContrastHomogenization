...
/-!
# Quantitative homogenization under uniform ellipticity: the statement vocabulary

This file carries the vocabulary of `HCPolyAudit.UniformHomogenization.Challenge`, word for
word, and is imported by `HCPolyAudit.UniformHomogenization.Solution`, so that the proved
