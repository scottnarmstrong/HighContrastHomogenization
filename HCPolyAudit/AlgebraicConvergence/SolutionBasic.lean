...
/-!
# Algebraic convergence at a polynomial scale: the statement vocabulary

This file carries the vocabulary of `HCPolyAudit.AlgebraicConvergence.Challenge`, word for
word, and is imported by `HCPolyAudit.AlgebraicConvergence.Solution`, so that the proved
