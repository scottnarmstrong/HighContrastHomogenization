...
/-!
# Polynomial entry into small contrast: the statement vocabulary

This file carries the vocabulary of `HCPolyAudit.PolynomialEntry.Challenge`, word for
word, and is imported by `HCPolyAudit.PolynomialEntry.Solution`, so that the proved
