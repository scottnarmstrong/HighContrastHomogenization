...
-/
import HCPolyAudit.Support.PolynomialHomogenizationBridge2

/-!
# The polynomial homogenization comparator solution

The theorem of `HCPolyAudit.PolynomialHomogenization.Challenge`, proved from the
library theorem through the bridges of
`HCPolyAudit.Support.PolynomialHomogenizationBridge1` and
`HCPolyAudit.Support.PolynomialHomogenizationBridge2`.  The statement below is the
