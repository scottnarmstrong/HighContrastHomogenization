...
This file carries the vocabulary of `HCPolyAudit.PolynomialHomogenization.Challenge`, word for
word, and is imported by `HCPolyAudit.PolynomialHomogenization.Solution`, so that the proved
