...
This file carries the vocabulary of `Audit.AlgebraicConvergence.Challenge`, word for
word, and is imported by `Audit.AlgebraicConvergence.Solution`, so that the proved
