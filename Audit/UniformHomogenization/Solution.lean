...
-/
import Audit.Support.UniformHomogenizationBridge

/-!
# The uniform homogenization comparator solution

The theorem of `Audit.UniformHomogenization.Challenge`, proved from the library
theorem through the bridges of `Audit.Support.UniformHomogenizationBridge`.  The
