...
This file carries the vocabulary of `Audit.UniformHomogenization.Challenge`, word for
word, and is imported by `Audit.UniformHomogenization.Solution`, so that the proved
