import HCPoly.Entry.Multiscale.ResponseInputs.HC3_RowsOscHalfCar
...
The adjoint twin of `HC3_RowsOscHalfCar`: the same carrier data for the recentred adjoint
