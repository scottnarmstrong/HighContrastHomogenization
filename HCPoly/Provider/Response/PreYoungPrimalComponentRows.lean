...
/-!
# Primal cutoff-mean component rows

The recent-difference and cutoff-oscillation estimates combine into the two
boundary rows used by the compact primal pre-Young estimate.
-/
