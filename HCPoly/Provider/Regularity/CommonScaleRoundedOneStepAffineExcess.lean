...
import HCPoly.Provider.Regularity.RoundedHarmonicAffineDecay
...
private theorem exists_roundedOneStepAffineExcessConstants_of_comparison
    (d : ℕ) [NeZero d] (s Ccomparison : ℝ) (hCcomparison : 0 ≤ Ccomparison) :
    ∃ N : ℕ, 0 < N ∧ ∃ C : ℝ, 0 ≤ C ∧
      ∀ (a : CoeffSpace d) (abar : Mat d)
        ...
        (∀ (k : ℤ)
          ...
          let W := roundedHarmonicReplacementDatum
          ...
          Book.Ch03.IsConstantCoeffForcedEquation (originCube d k)
            ...
            cubeBesovScaleWeight 1 (originCube d k) *
              ...
              Ccomparison * Transport.baseRoundedSpatialWeakError
                  a abar hS s k *
        ...
        ∀ (m : ℤ) (u : Book.Ch03.CubeSolution
          ...
          finiteCenteredCubeBestFitErrorAt aRounded m u
            ...
            (1 / 8 : ℝ) *
              ...
              C * Transport.baseRoundedSpatialWeakError a abar hS s k *
  ...
  obtain ⟨N₀, hN₀, hdecay⟩ :=
    exists_roundedReference_harmonic_normalized_affine_candidate_error_decay
      d theta htheta
  ...
  let W := roundedHarmonicReplacementDatum abar hS aRounded k uk.toH1 huk
  ...
  have hWweak : IsWeakSolutionOn
    ...
    simpa only [constantCoeffField_roundedReferenceConstantCoeffMatrix,
      roundedSymmetricReferenceCoefficient_apply_eq_roundedReferenceMatrix] using!
      isWeakSolutionOn_of_constantCoeffForcedEquation_zero
        (originCube d k) (roundedReferenceConstantCoeffMatrix abar hS) W.v hWeq
  ...
  have hH : H ≤ 3 * Ccomparison *
      Transport.baseRoundedSpatialWeakError a abar hS s k * D := by
    ...
    calc
      ...
      _ ≤ 3 * (Ccomparison * Transport.baseRoundedSpatialWeakError
          a abar hS s k *
            Book.Ch03.h1EnergyNormOnCube
  ...
  calc
    ...
    _ ≤ theta * R₁ * E + (A₀ + theta) *
          (3 * Ccomparison * Transport.baseRoundedSpatialWeakError
            a abar hS s k * D) := by
