...
-/
import HCPoly.Provider.PolynomialHomogenization.Root.Localization.GaugeReduction

/-!
# The scheduled localization hypothesis from a ruled Whitney row supply

The frozen Dirichlet clause consumes the scheduled localization hypothesis: on
the gauge-reduced domain it asks for a ruled scheduled localization package
together
...
`ScheduledLocalizationRowSupply`, stated at exactly the frozen spelling.
-/
