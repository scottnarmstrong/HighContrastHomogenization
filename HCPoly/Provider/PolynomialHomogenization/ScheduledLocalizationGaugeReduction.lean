...
The Dirichlet estimate is consumed on the gauge-reduced domain
...
/-- The gauge-reduced, skew-centered rescaled coefficient of the scheduled
estimate has a locally uniformly elliptic source representative. -/
